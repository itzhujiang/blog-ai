...
| 文件路径 | 操作类型 | 说明 |
|---------|---------|-----|
| `utils/models/db.ts` | 新增 | Sequelize 连接配置 |
| `utils/models/base.ts` | 新增 | 基础模型接口 |
| `utils/models/enums.ts` | 新增 | 枚举类型定义 |
| `utils/models/article.ts` | 新增 | 文章模型 |
| `utils/models/category.ts` | 新增 | 分类模型 |
| `utils/models/article-category.ts` | 新增 | 文章分类关联模型 |
| `utils/models/comment.ts` | 新增 | 评论模型 |
| `utils/models/media-file.ts` | 新增 | 媒体文件模型 |
| `utils/models/article-media.ts` | 新增 | 文章媒体关联模型 |
| `utils/models/about-page.ts` | 新增 | 关于页面模型 |
| `utils/models/about-page-media.ts` | 新增 | 关于页面媒体关联模型 |
| `utils/models/search-log.ts` | 新增 | 搜索日志模型 |
| `utils/models/site-setting.ts` | 新增 | 网站配置模型 |
| `utils/models/index.ts` | 新增 | 模型导出和关联配置 |
| `utils/logger.ts` | 新增 | log4js 日志配置 |
...
- 本项目是 Next.js 前端项目，模型放在 `utils/models/` 目录
